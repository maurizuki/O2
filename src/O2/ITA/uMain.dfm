object MainForm: TMainForm
  ...
  object ActionList: TActionList
    ...
    object ClearMRUList: TAction
      Category = 'File'
      Caption = 'Svuota lista file recenti'
      Hint = 'Svuota lista file recenti'
    ...
    object SaveFileAsCopy: TAction
      Category = 'File'
      Caption = 'Salva come copia...'
      Hint = 'Salva come copia'
    ...
    object ExportToHTML: TAction
      Category = 'File'
      Caption = 'Esporta come HTML...'
      Hint = 'Esporta come HTML'
    ...
    object ObjectTags: TAction
      Category = 'Object'
      Caption = 'Modifica etichette...'
      Hint = 'Modifica etichette'
      OnExecute = ObjectTagsExecute
      OnUpdate = ObjectActionUpdate
    end
    object ReplaceTag: TAction
      Category = 'Object'
      Caption = 'Sostituisci etichetta...'
      Hint = 'Sostituisci etichetta'
      OnExecute = ReplaceTagExecute
      OnUpdate = ObjectActionUpdate
    end
    object ReplaceFieldName: TAction
      Category = 'Object'
      Caption = 'Sostituisci nome campo...'
      Hint = 'Sostituisci nome campo'
      OnExecute = ReplaceFieldNameExecute
      OnUpdate = ObjectActionUpdate
    end
    object ReplaceFieldValue: TAction
      Category = 'Object'
      Caption = 'Sostituisci valore campo...'
      Hint = 'Sostituisci valore campo'
      OnExecute = ReplaceFieldValueExecute
      OnUpdate = ObjectActionUpdate
    end
    object ReplaceRole: TAction
      Category = 'Object'
      Caption = 'Sostituisci ruolo...'
      Hint = 'Sostituisci ruolo'
    ...
    object CopyValue: TAction
      Category = 'Field'
      Caption = 'Copia valore campo'
      Hint = 'Copia valore campo'
      OnExecute = CopyValueExecute
      OnUpdate = CopyNameValueUpdate
    end
    object CopyNameValueAsRow: TAction
      Category = 'Field'
      Caption = 'Copia nome e valore campo come riga'
      Hint = 'Copia nome e valore campo come riga'
      OnExecute = CopyNameValueAsRowExecute
      OnUpdate = CopyNameValueUpdate
    end
    object CopyNameValueAsColumn: TAction
      Category = 'Field'
      Caption = 'Copia nome e valore campo come colonna'
      Hint = 'Copia nome e valore campo come colonna'
      OnExecute = CopyNameValueAsColumnExecute
      OnUpdate = CopyNameValueUpdate
    end
    object CopyValuesAsRows: TAction
      Category = 'Field'
      Caption = 'Copia valori campi come righe'
      Hint = 'Copia valori campi come righe'
      OnExecute = CopyValuesAsRowsExecute
      OnUpdate = CopyUpdate
    end
    object CopyValuesAsColumns: TAction
      Category = 'Field'
      Caption = 'Copia valori campi come colonne'
      Hint = 'Copia valori campi come colonne'
      OnExecute = CopyValuesAsColumnsExecute
      OnUpdate = CopyUpdate
    end
    object CopyAsRows: TAction
      Category = 'Field'
      Caption = 'Copia come righe'
      Hint = 'Copia come righe'
    ...
    object CopyAsColumns: TAction
      Tag = 1
      Category = 'Field'
      Caption = 'Copia come colonne'
      Hint = 'Copia come colonne'
    ...
    object FileProps: TAction
      ...
      Hint = 'Propriet'#224' file'
      OnExecute = FilePropsExecute
      OnUpdate = ActionUpdate
    end
    object ImportSettings: TAction
      Category = 'Tools'
      Caption = 'Importa impostazioni...'
      Hint = 'Importa impostazioni'
      OnExecute = ImportSettingsExecute
      OnUpdate = ActionUpdate
    end
    object ExportSettings: TAction
      Category = 'Tools'
      Caption = 'Esporta impostazioni...'
      Hint = 'Esporta impostazioni'
      OnExecute = ExportSettingsExecute
      OnUpdate = ActionUpdate
    end
    object DefaultLanguage: TAction
      Category = 'Tools'
      Caption = 'Predefinita di sistema'
      Hint = 'Predefinita di sistema'
    ...
    object TransparencyOnlyIfDeactivated: TAction
      Category = 'Tools'
      Caption = 'Solo se inattivo'
      Hint = 'Trasparenza solo se inattivo'
    ...
    object InstallOnRemovableMedia: TAction
      Category = 'Tools'
      Caption = 'Installa su unit'#224' rimovibile'
      Hint = 'Installa su unit'#224' rimovibile'
      OnExecute = InstallOnRemovableMediaExecute
      OnUpdate = ActionUpdate
    end
    object CheckForUpdatesNow: TAction
      Category = 'Tools'
      Caption = 'Controlla aggiornamenti ora...'
      Hint = 'Controlla aggiornamenti ora'
      OnExecute = CheckForUpdatesNowExecute
      OnUpdate = ActionUpdate
    end
    object CheckForUpdatesPeriodically: TAction
      Category = 'Tools'
      Caption = 'Controlla aggiornamenti periodicamente...'
      Hint = 'Controlla aggiornamenti periodicamente'
      OnExecute = CheckForUpdatesPeriodicallyExecute
      OnUpdate = CheckForUpdatesPeriodicallyUpdate
    end
    object NewRelation: TAction
      Category = 'Relation'
      Caption = 'Nuova relazione...'
      Hint = 'Nuova relazione'
    ...
    object RelationGoToObj: TAction
      Category = 'Relation'
      Caption = 'Vai all'#39'oggetto'
      Hint = 'Vai all'#39'oggetto'
    ...
    object WebFeatureRequests: TAction
      Category = 'Help'
      Caption = 'Richieste nuove funzionalit'#224
    ...
    object WebBugTracker: TAction
      Category = 'Help'
      Caption = 'Segnalazioni di errore'
  ...
  object ObjectMenu: TPopupMenu
    ...
    object AddTag: TMenuItem
      ...
      Caption = 'Aggiungi etichetta'
      Hint = 'Aggiungi etichetta'
    end
    object DeleteTag: TMenuItem
      AutoHotkeys = maManual
      Caption = 'Elimina etichetta'
